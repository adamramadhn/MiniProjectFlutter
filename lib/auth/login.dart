...
class AuthUser {
  ...
  Future<ProfileData> register(String email, String password,String ava) async {
    var d = {"email": email, "password": password,"avatar":ava,"nama":"Update Your Name..","nohp":"Update your phone number.."};
    try {
